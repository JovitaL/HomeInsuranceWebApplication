...
@WebServlet("/GetQuote7_Serv")
public class GetQuote7_Serv extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Homeowner h = (Homeowner) session.getAttribute("homeowner");
		RequestDispatcher rd = request.getRequestDispatcher("GetQuote7.jsp");
